...
To build the final jar and optimize the UGDTFundsTransferMsvfinal application for production, run:
...
Then navigate to [http://localhost:9054](http://localhost:9054) in your browser.
